...
namespace TwitchRewardSlideshow.Utilities {
    public class FolderPicker {
        ...
        public virtual bool? ShowDialog(IntPtr owner, bool throwOnError = false) {
            ...
            if (CheckHr(dialog.GetResult(out var result), throwOnError) != 0) return null;
...
#pragma warning disable CA1712 // Do not prefix enum values with type name
        private enum SIGDN : uint {
            SIGDN_DESKTOPABSOLUTEEDITING = 0x8004c000, SIGDN_DESKTOPABSOLUTEPARSING = 0x80028000,
            SIGDN_FILESYSPATH = 0x80058000, SIGDN_NORMALDISPLAY = 0, SIGDN_PARENTRELATIVE = 0x80080001,
            SIGDN_PARENTRELATIVEEDITING = 0x80031001, SIGDN_PARENTRELATIVEFORADDRESSBAR = 0x8007c001,
            SIGDN_PARENTRELATIVEPARSING = 0x80018001, SIGDN_URL = 0x80068000
        }
        ...
        private enum FOS {
            ...
            FOS_FORCEPREVIEWPANEON = 0x40000000, FOS_SUPPORTSTREAMABLEITEMS = unchecked((int)0x80000000)
        }
